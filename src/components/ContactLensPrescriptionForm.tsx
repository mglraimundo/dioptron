...
export function ContactLensPrescriptionForm({ session, provider, onProviderUpdate, setField, setRefraction, handleAddBlur, handleLensTypeBlur }: Props) {
  ...
  const hasValidationError = EYES.some(eye =>
    DIOPTER_FIELDS.some(f => !isDiopterValid(clEyes[eye][f])) ||
    DECIMAL_FIELDS.some(f => !isDecimal2Valid(clEyes[eye][f]))
  );
  const canGenerate =
      ...
      <div className="p-6 flex flex-col gap-6">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="flex flex-col gap-1">
              <label htmlFor="cl-patientName" className="text-sm font-medium text-slate-600">
                Nome do Paciente
              </label>
              <input
                id="cl-patientName"
            ...
            <div className="flex flex-col gap-1">
              <label htmlFor="cl-healthSystemNumber" className="text-sm font-medium text-slate-600">
                Beneficiário
              </label>
              <input
                id="cl-healthSystemNumber"
                type="text"
                autoComplete="off"
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-7">
            <div className="flex flex-col gap-1">
              <label htmlFor="cl-lensTypeOD" className="text-sm font-medium text-slate-600">
                Lente Contacto OD
              </label>
              <input
                id="cl-lensTypeOD"
                type="text"
                autoComplete="off"
                value={session.lensTypeOD}
                onChange={e => setField('lensTypeOD', e.target.value)}
                onBlur={handleLensTypeBlur}
                className={`${inputClass} w-full`}
              />
            </div>
            <div className="flex flex-col gap-1">
              <label htmlFor="cl-lensTypeOE" className="text-sm font-medium text-slate-600">
                Lente Contacto OE
              </label>
              <input
                id="cl-lensTypeOE"
          ...
          <div className="flex flex-col gap-1 mt-4">
            <label htmlFor="cl-observacoes" className="text-sm font-medium text-slate-600">
              Observações
            </label>
            <textarea
              id="cl-observacoes"
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div className="flex flex-col gap-1">
              <label htmlFor="cl-licenseNumber" className="text-sm font-medium text-slate-600">
                Nº Cédula OM
              </label>
              <input
                id="cl-licenseNumber"
            ...
            <div className="flex flex-col gap-1">
              <label htmlFor="cl-prescriptionDate" className="text-sm font-medium text-slate-600">
                Data
              </label>
              <div className="relative">
                <input
                  id="cl-prescriptionDate"
                  type="text"
                  inputMode="numeric"
                  autoComplete="off"
